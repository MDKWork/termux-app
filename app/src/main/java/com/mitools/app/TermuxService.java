...
import com.mitools.app.event.SystemEventReceiver;
import com.mitools.app.terminal.TermuxTerminalSessionActivityClient;
import com.mitools.app.terminal.TermuxTerminalSessionServiceClient;
import com.mitools.shared.termux.plugins.TermuxPluginUtils;
import com.mitools.shared.data.IntentUtils;
import com.mitools.shared.net.uri.UriUtils;
import com.mitools.shared.errors.Errno;
import com.mitools.shared.shell.ShellUtils;
import com.mitools.shared.shell.command.runner.app.AppShell;
import com.mitools.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.mitools.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.mitools.shared.termux.shell.TermuxShellUtils;
...
import com.mitools.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.mitools.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.mitools.shared.termux.shell.TermuxShellManager;
...
import com.mitools.shared.notification.NotificationUtils;
...
import com.mitools.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.mitools.terminal.TerminalEmulator;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.mitools.shared.R.string.error_execution_cancelled))) {
