...
import com.mitools.shared.termux.terminal.io.BellHandler;
import com.mitools.shared.logger.Logger;
import com.mitools.terminal.TerminalColors;
import com.mitools.terminal.TerminalSession;
import com.mitools.terminal.TerminalSessionClient;
import com.mitools.terminal.TextStyle;
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                ...
                // Catch java.lang.RuntimeException: Unable to resume activity {com.mitools/com.mitools.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
