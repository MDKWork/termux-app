...
import com.mitools.shared.reflection.ReflectionUtils;
...
import com.mitools.shared.android.PackageUtils;
import com.mitools.shared.termux.TermuxConstants.TERMUX_APP;
...
public class TermuxUtils {
     ...
     *
     * If your third-party app is targeting sdk `30` (android `11`), then it needs to add `com.mitools`
     * package to the `queries` element or request `QUERY_ALL_PACKAGES` permission in its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{...... com.mitools/......} BLOCKED`
     ...
     * <manifest
     *     <queries>
     *         <package android:name="com.mitools" />
     *    </queries>
     * </manifest>
     * }
     *
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(com.mitools.shared.R.raw.apt_info_script);
        try {
