package com.mitools.shared.termux.file;
...
import com.mitools.shared.file.FileUtilsErrno;
...
public class TermuxFileUtils {
     ...
     *
     *
     * Also note that running `/system/bin/ls -lhd /data/user/0/com.mitools` as secondary user will result
     * in `ls: /data/user/0/com.mitools: Permission denied` where `0` is primary user id but running
     * `/system/bin/ls -lhd /data/user/10/com.mitools` will result in
     * `drwx------ 6 u10_a149 u10_a149 4.0K 2021-xx-xx xx:xx /data/user/10/com.mitools` where `10` is
